...
let groceries = ['milk', 'meat', 'noodles']
...
//////////////////STEP 5////////////////////
//Create a function called removeItem that takes in one parmater called index. Inside of the function remove the item from the groceries array above using 
// splice. Invoke the displayData() function again.
...
// You should now see the same thing you saw when you first loaded the page but you should now be able to add items to your grocery list with a dynamic 
// total showing. If you double click on an item, it should remove that item
